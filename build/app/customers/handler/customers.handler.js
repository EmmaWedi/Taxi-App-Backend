    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, req.dbCustomers.findOne({ where: { email: email } })];
            case 1:
                userExists = _b.sent();
                if (userExists !== null)
            ...
            case 4:
                uid = _b.sent();
                return [4 /*yield*/, req.dbCustomers.create({
                        email: email,
                        fullname: fullname,
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, req.dbCustomers.findOne({ where: { email: email, isBlocked: false } })];
            case 1:
                userExists = _b.sent();
                if (userExists === null)
            ...
            case 4:
                uid = _b.sent();
                return [4 /*yield*/, req.dbCustomers.update({ isActive: true, uid: uid.toUpperCase() }, { where: { id: userExists.id } })];
            case 5:
                _b.sent();
                return [2 /*return*/, res.json({
                        success: true,
...
var getCustomerDetails = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customer, details, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                customer = req.user;
                return [4 /*yield*/, req.dbCustomers.findOne({ where: { uid: customer.uid } })];
            case 1:
                details = _a.sent();
                if (details === null)
...
var updateCustomer = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customer, data, result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                customer = req.user;
                data = req.body;
                return [4 /*yield*/, req.dbCustomers.update(__assign({}, data), { where: { uid: customer.uid } })];
            case 1:
                result = _a.sent();
                if (result === null)
...
var logout = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customer, result, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                customer = req.user;
                return [4 /*yield*/, req.dbCustomers.update({ isActive: false }, { where: { uid: customer.uid } })];
            case 1:
                result = _a.sent();
                if (result === null)
                    throw Error('Could not update record');

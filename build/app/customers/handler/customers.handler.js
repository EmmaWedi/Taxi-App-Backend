...
var signin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                token = _b.sent();
                return [4 /*yield*/, req.dbCustomers.update({ isActive: true, uid: uid }, { where: { id: userExists.id } })];
            case 5:
                _b.sent();
                return [2 /*return*/, res.json({
                        success: true,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                auth = req.user;
                return [4 /*yield*/, req.dbCustomers.findOne({ where: { uid: auth.uid } })];
            case 1:
                details = _a.sent();
                if (details === null)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                auth = req.user;
                data = req.body;
                return [4 /*yield*/, req.dbCustomers.update(__assign({}, data), { where: { uid: auth.uid } })];
            case 1:
                result = _a.sent();
                if (result === null)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                auth = req.user;
                return [4 /*yield*/, req.dbCustomers.update({ isActive: false }, { where: { uid: auth.uid } })];
            case 1:
                result = _a.sent();
                if (result === null)
                    throw Error('Could not update record');

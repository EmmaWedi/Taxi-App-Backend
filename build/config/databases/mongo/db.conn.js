...
var dbConn = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        mongoose.set('strictQuery', true);
        if (db_config_1.DB_CONFIG.ENV === db_model_1.dbEnvironment.TEST) {
            return [2 /*return*/, mongoose.connect(db_config_1.DB_CONFIG.URL)];
        }
        return [2 /*return*/, mongoose.connect(db_config_1.DB_CONFIG.URL, {
                auth: {
